...
OceanEyes AI 水下助手 - 探索海洋世界的智能伙伴

OceanEyes AI 是一款基于先进深度学习技术的水下助手，专为潜水爱好者、海洋生物研究者和环保人士设计。通过实时视频分析，系统能够自动识别水下鱼类种类并判断其毒性，为用户提供安全保障。

应用支持多种操作模式：上传本地视频、使用手机摄像头实时录制，甚至可进行实时潜水检测。检测完成后，系统会生成详细的分析报告，包括鱼类种类、数量和毒性评估，并提供可视化的检测结果。

除了核心检测功能，OceanEyes AI 还内置了鱼类百科全书，用户可以浏览各种鱼类信息；社区分享功能让用户可以与其他潜水爱好者交流经验；个人中心则记录了用户的潜水历史和检测结果。

无论你是专业潜水员还是海洋爱好者，OceanEyes AI 都能为你的水下探索提供智能支持，让每一次潜水都成为一次安全、有趣且富有收获的体验。
## 项目结构
